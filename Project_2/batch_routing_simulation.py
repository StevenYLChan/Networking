...
# python test.py line_list_file.txt mesh_list_file.txt star_list_file.txt complete_list_file.txt tree_list_file.txt ring_list_file.txt adjacency_list_file.txt
...
def main():
    ...
    for argfile in arglist:
        ...
        average_no_transmissions, ci_no_transmissions, average_path_length, ci_path_length = hot_potato_1_routing(
            adj_list,
            no_nodes)
        output_hp1(average_no_transmissions, ci_no_transmissions, average_path_length, ci_path_length)

        # HOT POTATO ROUTING II
        average_no_transmissions, ci_no_transmissions, average_path_length, ci_path_length = hot_potato_2_routing(
            adj_list,
            no_nodes)
